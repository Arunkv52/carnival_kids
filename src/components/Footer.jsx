      ...
      <footer className="bg-[#48a8df] md:px-10 px-5 md:py-20 py-20">
        <div className="footer-top md:flex">
          <div className="ftop-1 md:w-[75%] w-full">
            <h6 className="text-white md:text-5xl text-2xl font-[Delicious_Handrawn]">
          ...
          <div className="ftop-2 md:w-[25%] w-full text-end md:pt-0 pt-10">
            <Link to={"/contact"}>
              <button className="bg-black text-white py-4 rounded-[50px] italic flex items-center gap-4 px-10 text-[20px] cursor-pointer">
                Connect with us{" "}
